...
env-harness-test:
	./tools/tests/test-capi-env-wrapper.sh
...
.PHONY: verify
verify: env-harness-test accelerator-verification benchmark-verification integration-verification integration-compile rtl-verification graphbrew-smoke verify-test
