...
void pageRankPullGraphCSRKernelAladdin(float *riDividedOnDiClause, float *pageRanks, float *pageRanksNext, __u32 *out_degree, __u32 *edges_idx, __u32 *sorted_edges_array, __u32 num_vertices);
