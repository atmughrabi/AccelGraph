...
set_global_assignment -name QIP_FILE  $PSL_FPGA/quartus_ip/fp_single_precision/fp_single_add_acc.qip
set_global_assignment -name QIP_FILE  $PSL_FPGA/quartus_ip/fp_double_precision/fp_double_add_acc.qip
