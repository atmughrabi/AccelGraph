...
set_global_assignment -name QIP_FILE  $PSL_FPGA/quartus_ip/fp/fp_single_precision_acc/fp_single_add_acc.qip
...
set_global_assignment -name QIP_FILE  $PSL_FPGA/quartus_ip/fp/fp_single_precision_mul/fp_single_mul.qip
