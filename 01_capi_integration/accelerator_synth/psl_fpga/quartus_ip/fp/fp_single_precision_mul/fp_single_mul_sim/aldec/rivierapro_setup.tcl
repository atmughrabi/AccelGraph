...
# ACDS 18.1 625 linux 2020.07.22.06:39:30
# ----------------------------------------
...
# ----------------------------------------
# If fp_single_mul is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_single_mul"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_single_mul.vo"
}
