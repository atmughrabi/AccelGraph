...
<img src="./02_slides/fig/openmp_logo.png" height="30" align="right" >
...
3. From the root directory you can modify the Makefile with the parameters you need for OpenMP:
  ...
  make run-openmp
  ```
<img src="./02_slides/fig/gem5-aladdin_logo.png" height="30" align="right" >
...
3. From the root directory you can modify the Makefile with the parameters you need for OpenMP:
  ...
  ```
<img src="./02_slides/fig/capi_logo.png" height="30" align="right" >
