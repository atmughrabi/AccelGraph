...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/synopsys/altera_merlin_slave_translator.sv"     -work alt_xcvr_reconfig_0_reconfig_mgmt_translator
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_p2b_adapter.vho"         -work p2b_adapter                                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_b2p_adapter.vho"         -work b2p_adapter                                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_transacto.vho"           -work transacto                                   
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_p2b.vho"                 -work p2b                                         
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_b2p.vho"                 -work b2p                                         
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_fifo.vho"                -work fifo                                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0_timing_adt.vho"          -work timing_adt                                  
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_mm_interconnect_0.vhd"            -work mm_interconnect_0                           
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/sfpp_reconfig_master_0.vhd"                     -work master_0                                    
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/sfpp_reconfig.vhd"                                                                                           
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/sfpp_reconfig_rst_controller.vhd"                                                                            
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/sfpp_reconfig_rst_controller_001.vhd"                                                                        
fi
