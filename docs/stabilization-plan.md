# AccelGraph stabilization plan

## Scope and acceptance

The benchmark is stable when host-only checks pass, every CAPI wait is bounded,
back-to-back CU launches observe reset completion, graph results match the
reference implementation, and failures identify the algorithm phase and
workload.
